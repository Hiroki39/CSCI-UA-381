...
## Each student should annotate slightly less than 29  files that will be duplicated
## Each student will also annotate the same 14 files as everyone else
## for a total of about 43 files each
...
def choose_about_3_colors(): 
    colors = ['black', 'blue', 'brown', 'green', 'orange', 'red', 'violet', 'white', 'yellow','skin']
    done = False
    choices = []
    while (not done):
